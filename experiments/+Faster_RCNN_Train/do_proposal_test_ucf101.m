function do_proposal_test_ucf101(conf, model_stage, output_dir, type, actionid)
...
proposal_test_ucf101(conf, output_dir, per_nms_topN, nms_overlap_thres, after_nms_topN, use_gpu, type, actionid,...
