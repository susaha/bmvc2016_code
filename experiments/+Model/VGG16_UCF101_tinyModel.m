...
% -------------------------------------------------------------------
function model = VGG16_UCF101_tinyModel(model, type, codebase_path)
...
model.stage1_rpn.solver_def_file                    = [codebase_path '/' 'models/tiny_model/rpn_prototxts/solver_240k320k.prototxt']; 
model.stage1_rpn.test_net_def_file                  = [codebase_path '/' 'models/tiny_model/rpn_prototxts/test.prototxt']; 
...
%%- fast rcnn, inited from pre-trained network
model.stage1_fast_rcnn.solver_def_file              = [codebase_path '/' 'models/tiny_model/fast_rcnn_prototxts/solver_240k320k.prototxt']; 
model.stage1_fast_rcnn.test_net_def_file            = [codebase_path '/' 'models/tiny_model/fast_rcnn_prototxts/test.prototxt'];
