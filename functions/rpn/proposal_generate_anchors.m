function anchors = proposal_generate_anchors(cache_name, output_dir, type, varargin)
...
%%--- inputs
    ...
    ip.parse(cache_name, output_dir, type, varargin{:});
    opts = ip.Results;

%%---
    if ~opts.ignore_cache
        
        anchor_cache_dir            = fullfile(opts.output_dir, ['rpn_trained_model_' opts.type]); 
