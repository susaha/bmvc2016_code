function proposal_test_ucf101_robocar(conf, output_dir, per_nms_topN, nms_overlap_thres, after_nms_topN, use_gpu, type, actionid,  varargin)
...
base_path_frcnn = '/home/suman/Downloads/faster_rcnn_final_model/output/faster_rcnn_final/faster_rcnn_VOC0712_vgg_16layers';
opts.net_def_file = [base_path_frcnn '/' 'proposal_test.prototxt'];
opts.net_file = [base_path_frcnn '/' 'proposal_final'];
...
img_path = '/home/suman/Desktop/sample_small/stereo/centre/*.png';
img_path_1 = '/home/suman/Desktop/sample_small/stereo/centre';
save_path = '/home/suman/Desktop/robocar_out';

img_list = dir(img_path);
num_imgs = length(img_list);

for i=1:num_imgs
    img_file = [img_path_1 '/' img_list(i).name];
    im = imread(img_file);
    save_file = [save_path '/' img_list(i).name];
    th = tic();
