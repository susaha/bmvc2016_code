...
%
% Multiplying (a) and (b) is the same as computed the average of the spatial iou over all frames in T_u of the two tubes, with a spatial
% iou of 0 for frames where only one box exists.
% c) as this is standard in detection problem, if there are multiple detections for the same groundtruth detection, 
% the first one is counted as positive and the other ones as negatives
% --------------------------------------------------------------------------------------------------------------------------------------
%{
gt_fnr = 1xn doube
