...
% --------------------------------------------------------
   ...
   %caffe_dir = fullfile('/home/suman/Code/faster_rcnn/external', 'caffe', 'matlab', caffe_version);
   
    caffe_dir = '/home/suman/Code/faster_rcnn/external/caffe/matlab'; % for sun
   %  caffe_dir = '/home/sumansaha/Code/faster_rcnn/external/caffe/matlab';
   %  % for ms beast
